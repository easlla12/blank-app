...
survival_features = [
    ...
    'Reginol Node Positive', 'Survival Months', 'Status'  # Assuming 'Survival Months' and 'Status' were used in training
    # --- REMOVE 'Survival Months' and 'Status' if they are the target variable and not input features ---
]
